        ...
        <div class="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div class="fade-up relative" style="transition-delay: 0.1s">
                <div class="aspect-[4/3] overflow-hidden rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10">
                    <img src="<?php echo e(asset('images/' . Str::slug($product['name']) . '.png')); ?>" alt="<?php echo e($product['name']); ?>" class="h-full w-full object-cover" onerror="this.onerror=null;this.src='<?php echo e(asset('images/abstractpattern.png')); ?>'">
                </div>
            </div>
        </div>
    </div>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($product['description'])): ?>
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="grid gap-12 lg:grid-cols-5">
            <div class="fade-up lg:col-span-3">
                ...
                <p class="mt-6 text-lg leading-relaxed text-neutral-300"><?php echo e($product['description']); ?></p>
