        ...
        <div class="grid items-center gap-16 lg:grid-cols-2">
            ...
            <div class="fade-up" style="transition-delay: 0.1s">
                ...
                <div class="mt-6 rounded-xl border border-primary-500/20 bg-primary-500/5 p-4">
                    <p class="text-sm text-primary-200"><strong class="text-primary-300">Note:</strong> As a <strong class="text-white">reinsurance broker</strong>, we act as an intermediary between insurance companies and reinsurers — we are not an insurance company or a reinsurance company. We do not underwrite risk or assume liability directly; instead, we facilitate the placement of risk with leading global and regional reinsurers on behalf of our clients.</p>
                </div>
            ...
            <div class="fade-up card-glass p-8 text-center" style="transition-delay: 0.2s">
                ...
                <div class="mt-6 grid gap-4 sm:grid-cols-5">
                    <div class="text-center">
                        <div class="mx-auto mb-2 flex h-10 w-10 items-center justify-center rounded-full bg-primary-600/10 text-primary-500">
                            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z"/></svg>
                        </div>
                        <h4 class="text-sm font-bold text-white">Professionalism</h4>
                    </div>
                    <div class="text-center">
                        <div class="mx-auto mb-2 flex h-10 w-10 items-center justify-center rounded-full bg-primary-600/10 text-primary-500">
                        ...
                        <h4 class="text-sm font-bold text-white">Accessibility</h4>
                    </div>
                    <div class="text-center">
                        <div class="mx-auto mb-2 flex h-10 w-10 items-center justify-center rounded-full bg-primary-600/10 text-primary-500">
                            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z"/></svg>
                    ...
                    <div class="text-center">
                        ...
                        <h4 class="text-sm font-bold text-white">Loyalty</h4>
                    </div>
                    <div class="text-center">
                        <div class="mx-auto mb-2 flex h-10 w-10 items-center justify-center rounded-full bg-primary-600/10 text-primary-500">
