...
<?php $__env->startSection('meta_description', 'Classic Reinsurance Brokers is Zimbabwe\'s premier reinsurance broker, delivering innovative and tailored reinsurance solutions across Africa since 2010.'); ?>
...
<script type="application/ld+json">
{
    ...
    "description": "Zimbabwe's premier reinsurance broker delivering innovative and tailored reinsurance solutions across Africa.",
    "mainEntity": [
        {
            "@type": "Organization",
...
<section class="relative overflow-hidden bg-gradient-to-br from-primary-950 via-primary-900 to-primary-800 px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="relative mx-auto max-w-7xl text-center">
        <div class="reveal">
            <span class="inline-flex items-center rounded-full bg-primary-500/20 px-4 py-1.5 text-sm font-medium text-primary-200 ring-1 ring-primary-500/30">About Us</span>
            <h1 class="section-title mt-6 text-white">About Classic Reinsurance Brokers</h1>
            <p class="section-subtitle mx-auto text-primary-100">
                Zimbabwe's premier reinsurance broker, delivering innovative and tailored reinsurance solutions across Africa since 2010.
            </p>
        </div>
    </div>
</section>
        ...
        <div class="reveal grid items-center gap-12 lg:grid-cols-2">
            <div class="relative">
                <div class="aspect-[4/3] overflow-hidden rounded-2xl shadow-xl">
                    <img src="<?php echo e(asset('images/about-who-we-are.jpg')); ?>" alt="Classic Reinsurance Brokers team" class="h-full w-full object-cover">
                </div>
                <div class="absolute -bottom-6 -right-6 hidden rounded-2xl bg-primary-600 p-6 shadow-lg lg:block">
            ...
            <div>
                ...
                <p class="mt-6 text-lg leading-relaxed text-neutral-600">
                    ...
                    solutions to insurance companies across Zimbabwe and the broader African market.
                </p>
    ...
    <div class="mx-auto max-w-7xl">
        ...
        <div class="mt-16 grid gap-8 lg:grid-cols-3">
            <div class="reveal card-hover stagger-children">
                <div class="mb-6 flex h-14 w-14 items-center justify-center rounded-xl bg-primary-100 text-primary-600">
            ...
            <div class="reveal card-hover stagger-children">
                <div class="mb-6 flex h-14 w-14 items-center justify-center rounded-xl bg-secondary-100 text-secondary-600">
                ...
                <p class="mt-4 leading-relaxed text-neutral-600">
                    To be the most respected and trusted reinsurance brokerage firm in Africa, recognized for our unwavering 
                    commitment to client success, innovation, and the highest standards of professionalism.
                </p>
            </div>
            <div class="reveal card-hover stagger-children">
                <div class="mb-6 flex h-14 w-14 items-center justify-center rounded-xl bg-amber-100 text-amber-600">
        ...
        <div class="reveal mt-12">
            <div class="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-neutral-100">
                <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-5">
                    <div class="text-center">
                        <div class="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-primary-100 text-primary-600">
                    ...
                    <div class="text-center">
                        <div class="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-secondary-100 text-secondary-600">
...
<section class="bg-white px-6 py-20 sm:py-28 lg:px-8">
    <div class="mx-auto max-w-7xl">
        <div class="reveal text-center">
            ...
            <p class="section-subtitle mx-auto">
                Comprehensive reinsurance solutions tailored to the unique needs of insurance companies across Africa.
            </p>
        </div>
        <div class="mt-16 grid gap-8 lg:grid-cols-3">
            <div class="reveal-scale card-hover stagger-children overflow-hidden">
                <div class="aspect-[16/10] overflow-hidden rounded-t-2xl bg-gradient-to-br from-primary-50 to-primary-100">
                    <img src="<?php echo e(asset('images/services-reinsurance-broking.jpg')); ?>" alt="Reinsurance Broking" class="h-full w-full object-cover">
                </div>
                <div class="p-6">
            ...
            <div class="reveal-scale card-hover stagger-children overflow-hidden">
                <div class="aspect-[16/10] overflow-hidden rounded-t-2xl bg-gradient-to-br from-secondary-50 to-secondary-100">
                    <img src="<?php echo e(asset('images/services-reinsurance-services.jpg')); ?>" alt="Reinsurance Services" class="h-full w-full object-cover">
                </div>
                <div class="p-6">
            ...
            <div class="reveal-scale card-hover stagger-children overflow-hidden">
                <div class="aspect-[16/10] overflow-hidden rounded-t-2xl bg-gradient-to-br from-amber-50 to-amber-100">
                    <img src="<?php echo e(asset('images/services-advisory.jpg')); ?>" alt="Advisory Services" class="h-full w-full object-cover">
                </div>
                <div class="p-6">
...
<section class="bg-neutral-50 px-6 py-20 sm:py-28 lg:px-8">
    <div class="mx-auto max-w-7xl">
        <div class="reveal text-center">
            ...
            <h2 class="section-title mt-3">Leadership Team</h2>
            <p class="section-subtitle mx-auto">
        ...
        <div class="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div class="reveal card-hover stagger-children text-center">
                <div class="mx-auto h-48 w-48 overflow-hidden rounded-full bg-primary-100 shadow-lg">
                    <img src="<?php echo e(asset('images/team/kingstone-mhinda.jpg')); ?>" alt="Kingstone Mhinda" class="h-full w-full object-cover">
                </div>
            ...
            <div class="reveal card-hover stagger-children text-center">
                <div class="mx-auto h-48 w-48 overflow-hidden rounded-full bg-secondary-100 shadow-lg">
                    <img src="<?php echo e(asset('images/team/nyasha-whende.jpg')); ?>" alt="Nyasha E Whende" class="h-full w-full object-cover">
                </div>
            ...
            <div class="reveal card-hover stagger-children text-center">
                <div class="mx-auto h-48 w-48 overflow-hidden rounded-full bg-amber-100 shadow-lg">
                    <img src="<?php echo e(asset('images/team/rachel-hakutangwi.jpg')); ?>" alt="Rachel N. Hakutangwi" class="h-full w-full object-cover">
                </div>
        ...
        <div class="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div class="reveal card-hover stagger-children text-center">
                ...
                <p class="mt-2 text-sm leading-relaxed text-neutral-500">
                    Deep understanding of African insurance and reinsurance markets with strong local and international relationships.
                </p>
            </div>
            <div class="reveal card-hover stagger-children text-center">
...
<section class="relative overflow-hidden bg-gradient-to-br from-primary-800 to-primary-950 px-6 py-20 sm:py-28 lg:px-8">
    <div class="absolute inset-0 bg-[url('<?php echo e(asset('images/cta-pattern.png')); ?>')] bg-cover bg-center opacity-5"></div>
