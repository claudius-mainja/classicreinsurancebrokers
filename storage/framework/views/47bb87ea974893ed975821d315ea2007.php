<?php $__env->startSection('title', 'Join Our Team'); ?>
<?php $__env->startSection('meta_description', 'Explore career opportunities at Classic Reinsurance Brokers — Zimbabwe\'s premier reinsurance broker.'); ?>
<?php $__env->startSection('og_title', 'Careers at Classic Reinsurance Brokers'); ?>
<?php $__env->startSection('og_description', 'Join Zimbabwe\'s premier reinsurance broker and build a rewarding career in reinsurance, risk management, and insurance broking.'); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($departments) && $departments->count() > 0): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="fade-up">
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <h3 class="text-xl font-bold text-white"><?php echo e($department->name); ?></h3>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($department->jobs->count() > 0): ?>
                            <div class="grid gap-4">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $department->jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="card-glass rounded-xl border border-neutral-800 bg-neutral-900/60 backdrop-blur-sm p-6 transition-all duration-300 hover:border-primary-600/30 group">
                                        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                            <div class="flex-1">
                                                <h4 class="text-lg font-bold text-white transition-colors group-hover:text-primary-600"><?php echo e($job->title); ?></h4>
                                                <div class="mt-2 flex flex-wrap items-center gap-3 text-sm text-neutral-400">
                                                    <span class="inline-flex items-center gap-1"><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg><?php echo e($job->location ?? 'Harare, Zimbabwe'); ?></span>
                                                    <span class="inline-flex items-center gap-1"><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg><?php echo e($job->type ?? 'Full-time'); ?></span>
                                                    <span class="inline-flex items-center gap-1"><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5"/></svg>Posted <?php echo e($job->created_at->diffForHumans()); ?></span>
                                                </div>
                                            </div>
                                            <a href="<?php echo e(route('careers.show', $job->slug)); ?>" class="btn bg-primary-600 text-white hover:bg-primary-500 shrink-0 text-sm">View & apply</a>
                                        </div>
                                    </div>
    ...
    <section class="py-20 lg:py-28 bg-neutral-950">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="fade-up text-center max-w-2xl mx-auto">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="btn bg-primary-600 text-white hover:bg-primary-500 mt-8">Get in touch</a>
            </div>
        </div>
    </section>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="mx-auto max-w-3xl px-6 text-center lg:px-8 relative z-10">
        <div class="fade-up">
            ...
            <div class="mt-10 flex flex-wrap items-center justify-center gap-4">
                <a href="<?php echo e(route('contact')); ?>?subject=Speculative%20Application" class="btn bg-primary-600 text-white hover:bg-primary-500 text-base px-8 py-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\claud\OneDrive\Desktop\classicreinsurancebrokers\resources\views/careers/index.blade.php ENDPATH**/ ?>