...
<?php $__env->startSection('meta_description', 'Explore career opportunities at Classic Reinsurance Brokers — Zimbabwe\'s premier reinsurance broker. Join our team of insurance and reinsurance professionals.'); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="reveal">
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <h3 class="text-2xl font-bold text-neutral-900"><?php echo e($department->name); ?></h3>
                        </div>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $department->jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="card-hover group rounded-2xl border border-neutral-100 bg-white p-6 shadow-sm transition-all duration-300 hover:shadow-md">
                                        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                            <div class="flex-1">
                                                <h4 class="text-lg font-bold text-neutral-900 transition-colors group-hover:text-primary-600"><?php echo e($job->title); ?></h4>
                                                <div class="mt-2 flex flex-wrap items-center gap-3 text-sm text-neutral-500">
                                                    <span class="inline-flex items-center gap-1">
                                                        ...
                                                        <?php echo e($job->location ?? 'Harare, Zimbabwe'); ?>

                                                    </span>
                                                    <span class="inline-flex items-center gap-1">
                                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                                                        <?php echo e($job->type ?? 'Full-time'); ?>
                                            ...
                                            <a href="<?php echo e(route('careers.apply', $job->slug)); ?>" class="btn-primary shrink-0 text-sm">Apply Now</a>
                                        </div>
                                    </div>
    ...
    <section class="bg-white px-6 py-20 sm:py-28 lg:px-8">
        <div class="mx-auto max-w-7xl">
            <div class="reveal text-center">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="btn-primary mt-8 inline-flex">Get in Touch</a>
            </div>
        </div>
    </section>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="relative mx-auto max-w-3xl text-center">
        <div class="reveal-scale">
            ...
            <div class="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                <a href="<?php echo e(route('careers.apply', 'speculative')); ?>" class="btn-primary bg-white text-primary-700 hover:bg-primary-50 hover:shadow-xl hover:shadow-white/25">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="btn-secondary border-white text-white hover:bg-white hover:text-primary-700">
                    Contact HR
