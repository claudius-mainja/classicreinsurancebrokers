...
<?php $__env->startSection('meta_description', 'Read the Terms & Conditions of Classic Reinsurance Brokers. Understand the terms governing the use of our website and reinsurance broking services.'); ?>
<?php $__env->startSection('og_title', 'Terms & Conditions | Classic Reinsurance Brokers'); ?>
<?php $__env->startSection('og_description', 'Classic Reinsurance Brokers Terms & Conditions — governing the use of our website, services, and the legal relationship between clients and our firm.'); ?>
    ...
    <div class="mx-auto max-w-3xl">
        ...
        <div class="reveal mt-12 rounded-2xl bg-neutral-50 p-8">
            ...
            <div class="mt-6 flex flex-wrap gap-4">
                ...
                <a href="<?php echo e(route('privacy')); ?>" class="btn-secondary text-sm">Privacy Policy</a>
            </div>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\claud\OneDrive\Desktop\classicreinsurancebrokers\resources\views/legal/terms.blade.php ENDPATH**/ ?>