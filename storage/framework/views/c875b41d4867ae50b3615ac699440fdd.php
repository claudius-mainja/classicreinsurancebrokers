    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-20 items-center justify-between">
            <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Classic Reinsurance Brokers" class="h-14 w-auto transition-all duration-300" :class="scrolled ? 'h-12' : 'h-14'">
            </a>
            ...
            <div class="hidden items-center gap-1 lg:flex">
                ...
                <div class="group relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                    <a href="<?php echo e(route('services')); ?>" class="inline-flex items-center gap-1 rounded-lg px-4 py-2 font-heading text-sm font-medium text-neutral-700 transition-all duration-200 hover:bg-neutral-100">
                        Services
