<nav class="site-nav fixed top-0 left-0 right-0 z-50 bg-white/98 backdrop-blur-md transition-all duration-300" x-data="{ mobileOpen: false, servicesOpen: false }">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="flex h-20 items-center justify-between">
            <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Classic Reinsurance Brokers" class="h-12 w-auto">
            </a>

            <div class="hidden items-center gap-1 lg:flex">
                <a href="<?php echo e(route('home')); ?>" class="rounded-lg px-4 py-2 text-sm font-medium text-neutral-700 transition-colors hover:bg-neutral-50 hover:text-primary-600">Home</a>
                <a href="<?php echo e(route('about')); ?>" class="rounded-lg px-4 py-2 text-sm font-medium text-neutral-700 transition-colors hover:bg-neutral-50 hover:text-primary-600">About Us</a>

                <div class="relative" @mouseenter="servicesOpen = true" @mouseleave="servicesOpen = false">
                    <a href="<?php echo e(route('services')); ?>" class="inline-flex items-center gap-1 rounded-lg px-4 py-2 text-sm font-medium text-neutral-700 transition-colors hover:bg-neutral-50 hover:text-primary-600">
                        Services
                ...
                <a href="<?php echo e(route('blog')); ?>" class="rounded-lg px-4 py-2 text-sm font-medium text-neutral-700 transition-colors hover:bg-neutral-50 hover:text-primary-600">Insights</a>
                <a href="<?php echo e(route('careers')); ?>" class="rounded-lg px-4 py-2 text-sm font-medium text-neutral-700 transition-colors hover:bg-neutral-50 hover:text-primary-600">Careers</a>
                <a href="<?php echo e(route('contact')); ?>" class="ml-4 rounded-full bg-primary-600 px-5 py-2.5 text-sm font-semibold text-white transition-all duration-300 hover:bg-primary-700">Contact Us</a>
            </div>
    ...
    <div x-show="mobileOpen" x-cloak class="border-t border-neutral-100 bg-white lg:hidden" x-transition:enter="transition duration-200" x-transition:enter-start="opacity-0 -translate-y-4" x-transition:enter-end="opacity-100 translate-y-0">
        <div class="space-y-1 px-4 py-4">
            <a href="<?php echo e(route('home')); ?>" class="block rounded-lg px-4 py-3 text-sm font-medium text-neutral-700 hover:bg-neutral-50">Home</a>
            <a href="<?php echo e(route('about')); ?>" class="block rounded-lg px-4 py-3 text-sm font-medium text-neutral-700 hover:bg-neutral-50">About Us</a>
            <details class="group">
                <summary class="flex cursor-pointer items-center justify-between rounded-lg px-4 py-3 text-sm font-medium text-neutral-700 hover:bg-neutral-50">
                    <a href="<?php echo e(route('services')); ?>" class="flex-1">Services</a>
                ...
                <div class="ml-4 mt-1 space-y-1 border-l-2 border-neutral-100 pl-4">
                    <a href="<?php echo e(route('services')); ?>" class="block rounded-lg px-4 py-2 text-sm text-neutral-600">All Services</a>
            ...
            <a href="<?php echo e(route('blog')); ?>" class="block rounded-lg px-4 py-3 text-sm font-medium text-neutral-700 hover:bg-neutral-50">Insights</a>
            <a href="<?php echo e(route('careers')); ?>" class="block rounded-lg px-4 py-3 text-sm font-medium text-neutral-700 hover:bg-neutral-50">Careers</a>
            <a href="<?php echo e(route('contact')); ?>" class="mt-4 block rounded-full bg-primary-600 px-5 py-3 text-center text-sm font-semibold text-white transition-all duration-300 hover:bg-primary-700">Contact Us</a>
        </div>
    </div>
</nav>
