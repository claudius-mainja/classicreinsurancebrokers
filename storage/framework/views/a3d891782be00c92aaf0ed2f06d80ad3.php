...
<?php $__env->startSection('meta_description', 'Read the Privacy Policy of Classic Reinsurance Brokers. Learn how we collect, use, protect, and handle your personal information in compliance with Zimbabwean data protection laws.'); ?>
<?php $__env->startSection('og_title', 'Privacy Policy | Classic Reinsurance Brokers'); ?>
<?php $__env->startSection('og_description', 'Classic Reinsurance Brokers is committed to protecting your privacy. Understand how we collect, use, and safeguard your personal data.'); ?>
...
<script type="application/ld+json">
{
    ...
    "mainEntity": {
        ...
        "privacyPolicy": "<?php echo e(url()->current()); ?>"
    }
}
</script>
<?php $__env->stopPush(); ?>
...
<section class="relative overflow-hidden bg-gradient-to-br from-primary-950 via-primary-900 to-primary-800 px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="relative mx-auto max-w-7xl text-center">
        <div class="reveal">
            ...
            <h1 class="section-title mt-6 text-white">Privacy Policy</h1>
    ...
    <div class="mx-auto max-w-3xl">
        ...
        <div class="reveal mt-12 rounded-2xl bg-neutral-50 p-8">
            ...
            <div class="mt-6 flex flex-wrap gap-4">
                <a href="<?php echo e(route('contact')); ?>" class="btn-primary text-sm">Contact Us</a>
                <a href="<?php echo e(route('terms')); ?>" class="btn-secondary text-sm">Terms &amp; Conditions</a>
            </div>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\claud\OneDrive\Desktop\classicreinsurancebrokers\resources\views/legal/privacy.blade.php ENDPATH**/ ?>