        ...
        <div class="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div class="fade-up relative" style="transition-delay: 0.1s">
                ...
                <div class="aspect-[4/3] overflow-hidden rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10">
                    <img src="<?php echo e(asset($specImage)); ?>" alt="<?php echo e($specialty['name']); ?>" class="h-full w-full object-cover" onerror="this.onerror=null;this.src='<?php echo e(asset($specImagePng)); ?>';this.onerror=null;this.src='<?php echo e(asset('images/hero-pattern.png')); ?>'">
                </div>
            </div>
        </div>
    </div>
