...
<section class="relative overflow-hidden bg-gradient-to-br from-neutral-950 via-neutral-900 to-primary-950 pt-28 pb-20 lg:pb-28">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid items-center gap-12 lg:grid-cols-2">
            <div class="reveal">
                <span class="inline-block rounded-full bg-primary-600/20 px-4 py-1.5 font-heading text-xs font-semibold uppercase tracking-widest text-primary-300">Specialty Risk</span>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-3xl text-center">
            ...
            <div class="reveal mt-10 flex flex-wrap items-center justify-center gap-4">
                <a href="<?php echo e(route('contact')); ?>" class="btn-primary bg-white text-primary-700 hover:bg-primary-50 hover:text-primary-800 shadow-lg shadow-primary-900/30">Contact Our Team</a>
