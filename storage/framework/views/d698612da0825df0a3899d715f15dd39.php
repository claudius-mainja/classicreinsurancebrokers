...
<script type="application/ld+json">
{
    ...
    "description": "Contact page for Classic Reinsurance Brokers, Zimbabwe's premier reinsurance broker.",
...
<section class="bg-white px-6 py-20 sm:py-28 lg:px-8">
    <div class="mx-auto max-w-7xl">
        <div class="grid gap-16 lg:grid-cols-2">
            <div class="reveal">
                <span class="text-sm font-semibold uppercase tracking-widest text-primary-600">Send Us a Message</span>
                <h2 class="section-title mt-3">Let's Start a Conversation</h2>
                ...
                <form action="<?php echo e(route('contact.submit')); ?>" method="POST" class="mt-10 space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <button type="submit" class="btn-primary inline-flex items-center gap-2">
                        Send Message
                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5"/></svg>
                    </button>
                </form>
            </div>
                    ...
                    <div class="mt-8 space-y-6">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm leading-relaxed text-neutral-600">
                                    11th Floor Fidelity Life Tower<br>
                                    5 Raleigh Street<br>
                                    Harare, Zimbabwe
                                </p>
                            </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <a href="tel:+263242773192" class="mt-1 block text-sm text-primary-600 transition-colors hover:text-primary-700">+263 242 773192</a>
                                <a href="tel:+263242773193" class="mt-1 block text-sm text-primary-600 transition-colors hover:text-primary-700">+263 242 773193</a>
                                <a href="tel:+263242773194" class="mt-1 block text-sm text-primary-600 transition-colors hover:text-primary-700">+263 242 773194</a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:info@classicre.co.zw" class="mt-1 block text-sm text-primary-600 transition-colors hover:text-primary-700">info@classicre.co.zw</a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="font-semibold text-neutral-900">Working Hours</h4>
                                <p class="mt-1 text-sm leading-relaxed text-neutral-600">
...
<section class="bg-neutral-50 px-6 py-20 sm:py-28 lg:px-8">
    <div class="mx-auto max-w-3xl">
        <div class="reveal text-center">
            <span class="text-sm font-semibold uppercase tracking-widest text-primary-600">FAQ</span>
            <h2 class="section-title mt-3">Frequently Asked Questions</h2>
            <p class="section-subtitle mx-auto">
                Quick answers to common questions about our services and how we can help your business.
            </p>
        </div>
        ...
        <div class="mt-12 space-y-3" x-data="{ open: null }">
            <div class="reveal rounded-2xl border border-neutral-200 bg-white transition-all duration-200" :class="open === 1 ? 'shadow-md border-primary-200' : ''">
                ...
                <div x-show="open === 1" x-collapse>
                    <div class="border-t border-neutral-100 px-6 py-5 text-sm leading-relaxed text-neutral-600">
            ...
            <div class="reveal rounded-2xl border border-neutral-200 bg-white transition-all duration-200" :class="open === 2 ? 'shadow-md border-primary-200' : ''">
                ...
                <div x-show="open === 2" x-collapse>
                    <div class="border-t border-neutral-100 px-6 py-5 text-sm leading-relaxed text-neutral-600">
                        You can request a quote by filling out our contact form, calling us at +263 242 773192/3/4, or emailing info@classicre.co.zw. Our team will respond within 24 hours to discuss your specific requirements and provide a tailored reinsurance solution.
                    </div>
                </div>
            </div>
            ...
            <div class="reveal rounded-2xl border border-neutral-200 bg-white transition-all duration-200" :class="open === 3 ? 'shadow-md border-primary-200' : ''">
                ...
                <div x-show="open === 3" x-collapse>
                    <div class="border-t border-neutral-100 px-6 py-5 text-sm leading-relaxed text-neutral-600">
                        We primarily serve insurance companies across Zimbabwe and the broader African market. Our extensive network of global and regional reinsurer relationships allows us to access capacity from markets including London, Lloyd's, Europe, South Africa, and Asia to structure optimal solutions for our clients.
                    </div>
                </div>
            </div>
            ...
            <div class="reveal rounded-2xl border border-neutral-200 bg-white transition-all duration-200" :class="open === 4 ? 'shadow-md border-primary-200' : ''">
                ...
                <div x-show="open === 4" x-collapse>
                    <div class="border-t border-neutral-100 px-6 py-5 text-sm leading-relaxed text-neutral-600">
                        We arrange both proportional (quota share, surplus) and non-proportional (excess of loss, stop loss) treaty reinsurance structures. Our team designs bespoke programmes that align with each client's risk appetite, portfolio characteristics, and growth objectives.
                    </div>
                </div>
            </div>
            ...
            <div class="reveal rounded-2xl border border-neutral-200 bg-white transition-all duration-200" :class="open === 5 ? 'shadow-md border-primary-200' : ''">
                ...
                <div x-show="open === 5" x-collapse>
                    <div class="border-t border-neutral-100 px-6 py-5 text-sm leading-relaxed text-neutral-600">
                        Our claims advocacy service ensures that your claims are managed efficiently and fairly. We assist with claim preparation, documentation, submission, and negotiation with reinsurers to ensure prompt and equitable settlement. Our team acts as your dedicated advocate throughout the claims process.
                    </div>
                </div>
            </div>
            ...
            <div class="reveal rounded-2xl border border-neutral-200 bg-white transition-all duration-200" :class="open === 6 ? 'shadow-md border-primary-200' : ''">
                ...
                <div x-show="open === 6" x-collapse>
                    <div class="border-t border-neutral-100 px-6 py-5 text-sm leading-relaxed text-neutral-600">
                        Yes, Classic Reinsurance Brokers is a licensed and regulated insurance brokerage firm operating in compliance with the Insurance and Pensions Commission (IPEC) of Zimbabwe. We adhere to the highest standards of professional conduct, financial security, and regulatory compliance.
                    </div>
                </div>
            </div>
        </div>
