...
<section id="reinsurance-products" class="bg-white py-20 lg:py-28">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <a href="<?php echo e(route('services.product', 'motor-insurance')); ?>" class="fade-up card border-neutral-200 bg-white p-6 group hover:shadow-lg hover:shadow-primary-500/10">
            ...
            <a href="<?php echo e(route('services.product', 'household')); ?>" class="fade-up card border-neutral-200 bg-white p-6 group hover:shadow-lg hover:shadow-primary-500/10" style="transition-delay: 0.05s">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-50 text-primary-600 transition-colors group-hover:bg-primary-600 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.product', 'engineering')); ?>" class="fade-up card border-neutral-200 bg-white p-6 group hover:shadow-lg hover:shadow-primary-500/10" style="transition-delay: 0.1s">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-50 text-primary-600 transition-colors group-hover:bg-primary-600 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.product', 'assets-all-risks')); ?>" class="fade-up card border-neutral-200 bg-white p-6 group hover:shadow-lg hover:shadow-primary-500/10" style="transition-delay: 0.15s">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-50 text-primary-600 transition-colors group-hover:bg-primary-600 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.product', 'liability-insurance')); ?>" class="fade-up card border-neutral-200 bg-white p-6 group hover:shadow-lg hover:shadow-primary-500/10" style="transition-delay: 0.2s">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-50 text-primary-600 transition-colors group-hover:bg-primary-600 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.product', 'group-personal-accidents')); ?>" class="fade-up card border-neutral-200 bg-white p-6 group hover:shadow-lg hover:shadow-primary-500/10" style="transition-delay: 0.25s">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-50 text-primary-600 transition-colors group-hover:bg-primary-600 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.product', 'travel-insurance')); ?>" class="fade-up card border-neutral-200 bg-white p-6 group hover:shadow-lg hover:shadow-primary-500/10" style="transition-delay: 0.3s">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-50 text-primary-600 transition-colors group-hover:bg-primary-600 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.product', 'goods-in-transit')); ?>" class="fade-up card border-neutral-200 bg-white p-6 group hover:shadow-lg hover:shadow-primary-500/10" style="transition-delay: 0.35s">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-50 text-primary-600 transition-colors group-hover:bg-primary-600 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.product', 'agriculture-insurance')); ?>" class="fade-up card border-neutral-200 bg-white p-6 group hover:shadow-lg hover:shadow-primary-500/10" style="transition-delay: 0.4s">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-50 text-primary-600 transition-colors group-hover:bg-primary-600 group-hover:text-white">
...
<section id="specialty-risk" class="bg-neutral-950 py-20 lg:py-28">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <a href="<?php echo e(route('services.specialty', 'aviation')); ?>" class="fade-up card-glass p-6 group">
            ...
            <a href="<?php echo e(route('services.specialty', 'bankers-blanket')); ?>" class="fade-up card-glass p-6 group" style="transition-delay: 0.05s">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-600/20 text-primary-400 ring-1 ring-primary-500/30 transition-all duration-300 group-hover:bg-primary-500 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.specialty', 'construction-projects')); ?>" class="fade-up card-glass p-6 group" style="transition-delay: 0.1s">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-600/20 text-primary-400 ring-1 ring-primary-500/30 transition-all duration-300 group-hover:bg-primary-500 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.specialty', 'cyber')); ?>" class="fade-up card-glass p-6 group" style="transition-delay: 0.15s">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-600/20 text-primary-400 ring-1 ring-primary-500/30 transition-all duration-300 group-hover:bg-primary-500 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.specialty', 'kidnap-and-ransom')); ?>" class="fade-up card-glass p-6 group" style="transition-delay: 0.2s">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-600/20 text-primary-400 ring-1 ring-primary-500/30 transition-all duration-300 group-hover:bg-primary-500 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.specialty', 'marine-hull')); ?>" class="fade-up card-glass p-6 group" style="transition-delay: 0.25s">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-600/20 text-primary-400 ring-1 ring-primary-500/30 transition-all duration-300 group-hover:bg-primary-500 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.specialty', 'power-projects')); ?>" class="fade-up card-glass p-6 group" style="transition-delay: 0.3s">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-600/20 text-primary-400 ring-1 ring-primary-500/30 transition-all duration-300 group-hover:bg-primary-500 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.specialty', 'political-risks')); ?>" class="fade-up card-glass p-6 group" style="transition-delay: 0.35s">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-600/20 text-primary-400 ring-1 ring-primary-500/30 transition-all duration-300 group-hover:bg-primary-500 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.specialty', 'political-violence-terrorism')); ?>" class="fade-up card-glass p-6 group" style="transition-delay: 0.4s">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-600/20 text-primary-400 ring-1 ring-primary-500/30 transition-all duration-300 group-hover:bg-primary-500 group-hover:text-white">
                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4.5c-.77-.833-2.694-.833-3.464 0L3.34 16.5c-.77.833.192 2.5 1.732 2.5z"/></svg>
                </div>
