    ...
    "itemListElement": [
        {
            ...
            "url": "<?php echo e(route('services.product', 'motor-insurance')); ?>"
        },
        {
            "@type": "ListItem",
            "position": 2,
            "name": "Household Insurance",
            "url": "<?php echo e(route('services.product', 'household')); ?>"
        },
        {
            "@type": "ListItem",
            "position": 3,
            "name": "Engineering Insurance",
            "url": "<?php echo e(route('services.product', 'engineering')); ?>"
        },
        {
            "@type": "ListItem",
            "position": 4,
            "name": "Assets All Risks",
            "url": "<?php echo e(route('services.product', 'assets-all-risks')); ?>"
        },
        {
            "@type": "ListItem",
            "position": 5,
            "name": "Liability Insurance",
            "url": "<?php echo e(route('services.product', 'liability-insurance')); ?>"
        },
        {
            "@type": "ListItem",
            "position": 6,
            "name": "Group Personal Accidents",
            "url": "<?php echo e(route('services.product', 'group-personal-accidents')); ?>"
        },
        {
            "@type": "ListItem",
            "position": 7,
            "name": "Travel Insurance",
            "url": "<?php echo e(route('services.product', 'travel-insurance')); ?>"
        },
        {
            "@type": "ListItem",
            "position": 8,
            "name": "Goods In Transit",
            "url": "<?php echo e(route('services.product', 'goods-in-transit')); ?>"
        },
        {
            "@type": "ListItem",
            "position": 9,
            "name": "Agriculture Insurance",
            "url": "<?php echo e(route('services.product', 'agriculture-insurance')); ?>"
        },
        {
            "@type": "ListItem",
            "position": 10,
            "name": "Aviation Insurance",
            "url": "<?php echo e(route('services.specialty', 'aviation')); ?>"
        },
        {
            "@type": "ListItem",
            "position": 11,
            "name": "Bankers' Blanket Insurance",
            "url": "<?php echo e(route('services.specialty', 'bankers-blanket')); ?>"
        },
        {
            "@type": "ListItem",
            "position": 12,
            "name": "Construction Projects Insurance",
            "url": "<?php echo e(route('services.specialty', 'construction-projects')); ?>"
        },
        {
            "@type": "ListItem",
            "position": 13,
            "name": "Cyber Insurance",
            "url": "<?php echo e(route('services.specialty', 'cyber')); ?>"
        },
        {
            "@type": "ListItem",
            "position": 14,
            "name": "Kidnap & Ransom Insurance",
            "url": "<?php echo e(route('services.specialty', 'kidnap-and-ransom')); ?>"
        },
        {
            "@type": "ListItem",
            "position": 15,
            "name": "Marine Hull Insurance",
            "url": "<?php echo e(route('services.specialty', 'marine-hull')); ?>"
        },
        {
            "@type": "ListItem",
            "position": 16,
            "name": "Power Projects Insurance",
            "url": "<?php echo e(route('services.specialty', 'power-projects')); ?>"
        },
        {
            "@type": "ListItem",
            "position": 17,
            "name": "Political Risks Insurance",
            "url": "<?php echo e(route('services.specialty', 'political-risks')); ?>"
        },
        {
            "@type": "ListItem",
            "position": 18,
            "name": "Political Violence & Terrorism Insurance",
            "url": "<?php echo e(route('services.specialty', 'political-violence-terrorism')); ?>"
        }
    ]
}
</script>
...
<section id="reinsurance-products" class="relative bg-white py-20 lg:py-28">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="stagger-children mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <a href="<?php echo e(route('services.product', 'motor-insurance')); ?>" class="card-hover group">
            ...
            <a href="<?php echo e(route('services.product', 'household')); ?>" class="card-hover group">
                <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-primary-50 text-primary-600 transition-colors group-hover:bg-primary-600 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.product', 'engineering')); ?>" class="card-hover group">
                <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-primary-50 text-primary-600 transition-colors group-hover:bg-primary-600 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.product', 'assets-all-risks')); ?>" class="card-hover group">
                <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-primary-50 text-primary-600 transition-colors group-hover:bg-primary-600 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.product', 'liability-insurance')); ?>" class="card-hover group">
                <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-primary-50 text-primary-600 transition-colors group-hover:bg-primary-600 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.product', 'group-personal-accidents')); ?>" class="card-hover group">
                <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-primary-50 text-primary-600 transition-colors group-hover:bg-primary-600 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.product', 'travel-insurance')); ?>" class="card-hover group">
                <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-primary-50 text-primary-600 transition-colors group-hover:bg-primary-600 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.product', 'goods-in-transit')); ?>" class="card-hover group">
                <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-primary-50 text-primary-600 transition-colors group-hover:bg-primary-600 group-hover:text-white">
            ...
            <a href="<?php echo e(route('services.product', 'agriculture-insurance')); ?>" class="card-hover group">
                <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-primary-50 text-primary-600 transition-colors group-hover:bg-primary-600 group-hover:text-white">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-3xl text-center">
            ...
            <div class="reveal mt-10 flex flex-wrap items-center justify-center gap-4">
                <a href="<?php echo e(route('contact')); ?>" class="btn-primary bg-white text-primary-700 hover:bg-primary-50 hover:text-primary-800 shadow-lg shadow-primary-900/30">Get In Touch</a>
