                            ...
                            <article class="card-hover group overflow-hidden rounded-md bg-white shadow-sm ring-1 ring-neutral-100 transition-all duration-300 hover:shadow-lg">
                                ...
                                <div class="p-6">
                                    <div class="mb-3 flex flex-wrap items-center gap-2">
                                        <span class="inline-flex items-center rounded-md bg-primary-50 px-3 py-1 text-xs font-medium text-primary-700"><?php echo e($post->category->name ?? 'Insurance'); ?></span>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a href="<?php echo e(route('blog.category', $category->slug)); ?>" class="flex items-center justify-between rounded-lg px-3 py-2 text-sm text-neutral-600 transition-colors hover:bg-white hover:text-primary-600 <?php echo e(request('category') === $category->slug ? 'bg-white text-primary-600 font-medium' : ''); ?>">
                                        ...
                                        <span class="rounded-md bg-neutral-200 px-2 py-0.5 text-xs text-neutral-500"><?php echo e($category->posts_count ?? 0); ?></span>
                                    </a>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </ul>
                    ...
                    <div class="reveal rounded-md bg-neutral-50 p-6">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $tags ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('blog.tag', $tag->slug)); ?>" class="rounded-md bg-white px-3 py-1.5 text-xs font-medium text-neutral-600 shadow-sm transition-colors hover:bg-primary-50 hover:text-primary-600 <?php echo e(request('tag') === $tag->slug ? 'bg-primary-50 text-primary-600' : ''); ?>">
                                    <?php echo e($tag->name); ?>
