...
<section class="relative flex min-h-screen items-center justify-center overflow-hidden bg-neutral-950">
    <div class="absolute inset-0">
        <img src="<?php echo e(asset('images/herobg.png')); ?>" alt="" class="h-full w-full object-cover opacity-40">
    ...
    <div class="relative z-10 mx-auto max-w-7xl px-6 text-center">
        <div class="mx-auto max-w-4xl">
            ...
            <div class="hero-animate mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                <a href="<?php echo e(route('contact')); ?>" class="btn-primary">Schedule a Consultation</a>
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="grid items-center gap-16 lg:grid-cols-2">
            ...
            <div class="reveal-right">
                ...
                <a href="<?php echo e(route('services')); ?>" class="mt-8 inline-flex items-center gap-2 rounded-full bg-primary-600 px-6 py-3 text-sm font-semibold text-white transition-all duration-300 hover:bg-primary-700">
...
<section id="solutions" class="bg-neutral-950 py-24 lg:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="reveal mt-12 text-center">
            <a href="<?php echo e(route('services')); ?>" class="btn-outline-light">View All Services</a>
        </div>
    </div>
</section>
...
<section class="bg-white py-24 lg:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="reveal mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <a href="<?php echo e(route('services.product', 'motor-insurance')); ?>" class="service-card group p-8">
            ...
            <a href="<?php echo e(route('services.product', 'engineering')); ?>" class="service-card group p-8">
                <div class="service-icon mb-4">
            ...
            <a href="<?php echo e(route('services.product', 'household')); ?>" class="service-card group p-8">
                <div class="service-icon mb-4">
            ...
            <a href="<?php echo e(route('services.product', 'assets-all-risks')); ?>" class="service-card group p-8">
                <div class="service-icon mb-4">
            ...
            <a href="<?php echo e(route('services.product', 'liability-insurance')); ?>" class="service-card group p-8">
                <div class="service-icon mb-4">
                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                </div>
            ...
            <a href="<?php echo e(route('services.product', 'agriculture-insurance')); ?>" class="service-card group p-8">
                <div class="service-icon mb-4">
...
<section class="bg-white py-24 lg:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="reveal mt-16 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <a href="<?php echo e(route('services.specialty', 'aviation')); ?>" class="service-card flex items-center gap-4 p-5">
            ...
            <a href="<?php echo e(route('services.specialty', 'bankers-blanket')); ?>" class="service-card flex items-center gap-4 p-5">
            ...
            <a href="<?php echo e(route('services.specialty', 'construction-projects')); ?>" class="service-card flex items-center gap-4 p-5">
                <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-primary-50 text-primary-600">
            ...
            <a href="<?php echo e(route('services.specialty', 'cyber')); ?>" class="service-card flex items-center gap-4 p-5">
                <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-primary-50 text-primary-600">
            ...
            <a href="<?php echo e(route('services.specialty', 'marine-hull')); ?>" class="service-card flex items-center gap-4 p-5">
                <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-primary-50 text-primary-600">
            ...
            <a href="<?php echo e(route('services.specialty', 'power-projects')); ?>" class="service-card flex items-center gap-4 p-5">
                <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-primary-50 text-primary-600">
            ...
            <a href="<?php echo e(route('services.specialty', 'kidnap-and-ransom')); ?>" class="service-card flex items-center gap-4 p-5">
                <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-primary-50 text-primary-600">
            ...
            <a href="<?php echo e(route('services.specialty', 'political-risks')); ?>" class="service-card flex items-center gap-4 p-5">
                <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-primary-50 text-primary-600">
            ...
            <a href="<?php echo e(route('services.specialty', 'political-violence-terrorism')); ?>" class="service-card flex items-center gap-4 p-5">
                <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-primary-50 text-primary-600">
                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4.5c-.77-.833-2.694-.833-3.464 0L3.34 16.5c-.77.833.192 2.5 1.732 2.5z"/></svg>
                </div>
                <div>
    ...
    <div class="mx-auto max-w-7xl px-6 text-center">
        <div class="reveal-scale mx-auto max-w-3xl">
            ...
            <div class="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                <a href="<?php echo e(route('contact')); ?>" class="btn-primary">Request a Consultation</a>
