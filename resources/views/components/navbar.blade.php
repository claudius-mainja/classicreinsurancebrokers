<nav class="nav fixed top-0 left-0 right-0 z-50 transition-all duration-500" x-data="{ mobileOpen: false, scrolled: false }" x-init="window.addEventListener('scroll', () => scrolled = window.scrollY > 80)" :class="scrolled ? 'nav-scrolled bg-white/95 backdrop-blur-md shadow-sm' : 'bg-transparent'">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-20 items-center justify-between">
            ...
            <div class="hidden items-center gap-1 lg:flex">
                <a href="{{ route('home') }}" class="rounded-lg px-4 py-2 font-heading text-sm font-medium text-neutral-700 transition-all duration-200 hover:bg-neutral-100">Home</a>
    ...
    <div x-show="mobileOpen" x-cloak class="border-t border-neutral-100 bg-white lg:hidden" x-transition:enter="transition duration-200" x-transition:enter-start="opacity-0 -translate-y-4" x-transition:enter-end="opacity-100 translate-y-0">
        <div class="space-y-1 px-4 py-4">
            <a href="{{ route('home') }}" class="block rounded-lg px-4 py-3 font-heading text-sm font-medium text-neutral-700 hover:bg-neutral-50">Home</a>
            ...
            <details class="group">
                ...
                <div class="ml-4 mt-1 space-y-1 border-l-2 border-neutral-100 pl-4">
                    <a href="{{ route('services') }}" class="block rounded-lg px-4 py-2 text-sm text-neutral-600 hover:text-primary-600">All Services</a>
            ...
            <a href="{{ route('blog') }}" class="block rounded-lg px-4 py-3 font-heading text-sm font-medium text-neutral-700 hover:bg-neutral-50">Insights</a>
            <a href="{{ route('careers') }}" class="block rounded-lg px-4 py-3 font-heading text-sm font-medium text-neutral-700 hover:bg-neutral-50">Careers</a>
            <a href="{{ route('contact') }}" class="mt-4 block rounded-lg bg-primary-600 px-5 py-3 text-center font-heading text-sm font-semibold text-white transition-all duration-300 hover:bg-primary-700">Contact Us</a>
        </div>
    </div>
</nav>
