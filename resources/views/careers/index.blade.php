...
<section class="hero-gradient min-h-[40vh] flex items-center">
    <div class="mx-auto max-w-7xl px-6 lg:px-8 py-24 lg:py-32">
        <div class="max-w-3xl">
            <span class="fade-up inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-1.5 text-xs font-semibold text-primary-200">Careers</span>
    ...
    <section class="py-20 lg:py-28">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="fade-up text-center max-w-2xl mx-auto">
                ...
                <h2 class="mt-4 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">Current vacancies</h2>
                <p class="mt-4 text-lg text-neutral-500">Explore our current openings across all departments.</p>
            </div>
                ...
                @foreach($departments as $department)
                    <div class="fade-up">
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <h3 class="text-xl font-bold">{{ $department->name }}</h3>
                        </div>
                        @if($department->jobs->count() > 0)
                            <div class="grid gap-4">
                                @foreach($department->jobs as $job)
                                    <div class="card p-6 transition-all duration-300 hover:shadow-md group">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="fade-up text-center max-w-2xl mx-auto">
                <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-neutral-100">
                    <svg class="h-8 w-8 text-neutral-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z"/></svg>
                </div>
                <h2 class="mt-6 text-3xl font-bold">No open positions right now</h2>
                <p class="mt-4 text-lg text-neutral-500">We don't have any vacancies at the moment, but we're always interested in connecting with talented professionals. Send us your CV and we'll keep you in mind for future opportunities.</p>
                <a href="{{ route('contact') }}" class="btn btn-primary mt-8">Get in touch</a>
            </div>
        </div>
    </section>
@endif
...
<section class="border-t border-neutral-100 bg-neutral-50/50 py-20 lg:py-28">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="fade-up max-w-2xl mx-auto text-center">
            ...
            <h2 class="mt-4 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">Life at Classic Reinsurance Brokers</h2>
            <p class="mt-4 text-lg text-neutral-500">We foster a culture of excellence, collaboration, and continuous growth.</p>
        </div>
        <div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div class="fade-up card p-6 text-center">
                ...
                <h3 class="mt-4 text-base font-bold">Professional Growth</h3>
                <p class="mt-2 text-sm text-neutral-500">Continuous learning and development opportunities with a clear career progression path.</p>
            </div>
            <div class="fade-up card p-6 text-center" style="transition-delay: 0.1s">
                ...
                <h3 class="mt-4 text-base font-bold">Collaborative Environment</h3>
                <p class="mt-2 text-sm text-neutral-500">Work alongside industry experts in a supportive, team-oriented environment.</p>
            </div>
            <div class="fade-up card p-6 text-center" style="transition-delay: 0.2s">
                ...
                <h3 class="mt-4 text-base font-bold">Open Communication</h3>
                <p class="mt-2 text-sm text-neutral-500">Transparent dialogue at all levels. Your voice matters and diverse perspectives are valued.</p>
            </div>
            <div class="fade-up card p-6 text-center" style="transition-delay: 0.3s">
                ...
                <h3 class="mt-4 text-base font-bold">Work-Life Balance</h3>
                <p class="mt-2 text-sm text-neutral-500">We prioritise well-being with flexible working arrangements and healthy balance.</p>
            </div>
        </div>
    </div>
</section>
