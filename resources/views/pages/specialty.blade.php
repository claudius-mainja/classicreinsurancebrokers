    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-3xl text-center">
            ...
            <div class="reveal mt-10 flex flex-wrap items-center justify-center gap-4">
                <a href="{{ route('contact') }}" class="btn-primary bg-white text-secondary-700 hover:bg-secondary-50 hover:text-secondary-800 shadow-lg shadow-secondary-900/30">Contact Our Team</a>
