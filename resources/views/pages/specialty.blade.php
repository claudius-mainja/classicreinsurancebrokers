...
<section class="relative overflow-hidden bg-gradient-to-br from-neutral-950 via-neutral-900 to-primary-950 pt-28 pb-20 lg:pb-28">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid items-center gap-12 lg:grid-cols-2">
            <div class="reveal">
                <span class="inline-block rounded-lg bg-primary-600/20 px-4 py-1.5 font-heading text-xs font-semibold uppercase tracking-widest text-primary-300">Specialty Risk</span>
                <h1 class="mt-6 font-heading text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">{{ $specialty['name'] }}</h1>
                <p class="mt-6 text-lg leading-relaxed text-neutral-300">{{ $specialty['description'] }}</p>
                <div class="mt-8 flex flex-wrap gap-4">
                    <a href="{{ route('contact') }}" class="btn-primary text-sm">Discuss Your Risk</a>
                    <a href="{{ route('services') }}" class="btn-secondary border-white text-white hover:bg-white hover:text-neutral-900 text-sm">View All Specialties</a>
                </div>
            </div>
            <div class="reveal-scale relative">
                <div class="aspect-[4/3] overflow-hidden rounded-lg shadow-2xl">
...
<section class="bg-white py-20 lg:py-28">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-2xl text-center">
            <span class="reveal inline-block rounded-full bg-primary-50 px-4 py-1.5 font-heading text-xs font-semibold uppercase tracking-widest text-primary-700">Service Details</span>
        ...
        <div class="stagger-children mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="card-hover group">
                ...
                <h3 class="font-heading text-lg font-bold text-neutral-900">{{ $feature }}</h3>
                <p class="mt-2 text-sm leading-relaxed text-neutral-600">Bespoke reinsurance solutions for {{ lcfirst($feature) }}, supported by deep underwriting expertise and access to global specialty markets.</p>
            </div>
            @empty
...
<section class="bg-neutral-50 py-20 lg:py-28">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-2xl text-center">
            <span class="reveal inline-block rounded-full bg-primary-50 px-4 py-1.5 font-heading text-xs font-semibold uppercase tracking-widest text-primary-700">Why Partner With Us</span>
        ...
        <div class="reveal mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="card-hover text-center">
                <div class="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-lg bg-primary-100 text-primary-600">
...
<section class="relative overflow-hidden bg-gradient-to-br from-primary-700 via-primary-600 to-primary-800 py-20 lg:py-28">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-3xl text-center">
            ...
            <p class="reveal mt-6 text-lg leading-relaxed text-primary-100">Our specialty team is ready to help you navigate complex risks with bespoke reinsurance solutions. Contact us to discuss how we can support your unique requirements.</p>
            <div class="reveal mt-10 flex flex-wrap items-center justify-center gap-4">
                <a href="{{ route('contact') }}" class="btn-primary bg-white text-primary-700 hover:bg-primary-50 hover:text-primary-800 shadow-lg shadow-primary-900/30">Contact Our Team</a>
