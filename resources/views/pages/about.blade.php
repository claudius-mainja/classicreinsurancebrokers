...
@section('meta_description', 'Classic Reinsurance Brokers is Zimbabwe\'s premier reinsurance broker, delivering innovative and tailored reinsurance solutions across Africa since 2010.')
        ...
        <div class="reveal grid items-center gap-12 lg:grid-cols-2">
            <div class="relative">
                <div class="aspect-[4/3] overflow-hidden rounded-2xl shadow-xl">
                    <img src="{{ asset('images/about-who-we-are.jpg') }}" alt="Classic Reinsurance Brokers team" class="h-full w-full object-cover">
                </div>
        ...
        <div class="mt-16 grid gap-8 lg:grid-cols-3">
            <div class="reveal-scale card-hover stagger-children overflow-hidden">
                <div class="aspect-[16/10] overflow-hidden rounded-t-2xl bg-gradient-to-br from-primary-50 to-primary-100">
                    <img src="{{ asset('images/services-reinsurance-broking.jpg') }}" alt="Reinsurance Broking" class="h-full w-full object-cover">
                </div>
                <div class="p-6">
            ...
            <div class="reveal-scale card-hover stagger-children overflow-hidden">
                <div class="aspect-[16/10] overflow-hidden rounded-t-2xl bg-gradient-to-br from-secondary-50 to-secondary-100">
                    <img src="{{ asset('images/services-reinsurance-services.jpg') }}" alt="Reinsurance Services" class="h-full w-full object-cover">
                </div>
                <div class="p-6">
            ...
            <div class="reveal-scale card-hover stagger-children overflow-hidden">
                <div class="aspect-[16/10] overflow-hidden rounded-t-2xl bg-gradient-to-br from-amber-50 to-amber-100">
                    <img src="{{ asset('images/services-advisory.jpg') }}" alt="Advisory Services" class="h-full w-full object-cover">
                </div>
                <div class="p-6">
        ...
        <div class="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div class="reveal card-hover stagger-children text-center">
                <div class="mx-auto h-48 w-48 overflow-hidden rounded-full bg-primary-100 shadow-lg">
                    <img src="{{ asset('images/team/kingstone-mhinda.jpg') }}" alt="Kingstone Mhinda" class="h-full w-full object-cover">
                </div>
            ...
            <div class="reveal card-hover stagger-children text-center">
                <div class="mx-auto h-48 w-48 overflow-hidden rounded-full bg-secondary-100 shadow-lg">
                    <img src="{{ asset('images/team/nyasha-whende.jpg') }}" alt="Nyasha E Whende" class="h-full w-full object-cover">
                </div>
            ...
            <div class="reveal card-hover stagger-children text-center">
                <div class="mx-auto h-48 w-48 overflow-hidden rounded-full bg-amber-100 shadow-lg">
                    <img src="{{ asset('images/team/rachel-hakutangwi.jpg') }}" alt="Rachel N. Hakutangwi" class="h-full w-full object-cover">
                </div>
    ...
    <div class="relative mx-auto max-w-3xl text-center">
        <div class="reveal-scale">
            ...
            <div class="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                <a href="{{ route('contact') }}" class="btn-primary bg-white text-primary-700 hover:bg-primary-50 hover:shadow-xl hover:shadow-white/25">
                    Contact Us Today
