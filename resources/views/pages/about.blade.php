...
<section class="relative flex min-h-[60vh] items-center justify-center overflow-hidden">
    <div class="absolute inset-0">
        <img src="{{ asset('images/abouthero.png') }}" alt="About Classic Reinsurance Brokers" class="h-full w-full object-cover">
    ...
    <div class="relative z-10 mx-auto max-w-4xl px-4 text-center">
        <div>
            ...
            <div class="hero-animate mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                ...
                <a href="{{ route('contact') }}" class="inline-flex items-center gap-2 rounded-md border-2 border-white/30 px-8 py-4 text-base font-semibold text-white transition-all duration-300 hover:border-white hover:bg-white/10">Contact Us</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="reveal grid items-center gap-12 lg:grid-cols-2">
            <div class="relative">
                <div class="img-zoom aspect-[4/3] overflow-hidden rounded-md shadow-xl">
                    <img src="{{ asset('images/about.jpg') }}" alt="Classic Reinsurance Brokers team" class="img-reveal h-full w-full object-cover">
                </div>
            ...
            <div>
                ...
                <div class="mt-8 flex flex-wrap gap-4">
                    ...
                    <a href="{{ route('services') }}" class="btn-secondary">Our Services</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
            <div class="reveal card-hover stagger-children text-center">
                <div class="img-zoom mx-auto h-48 w-48 overflow-hidden rounded-md bg-primary-100 shadow-lg">
                    <img src="{{ asset('images/Kingstone.png') }}" alt="Kingstone Mhinda" class="img-reveal h-full w-full object-cover">
                </div>
            ...
            <div class="reveal card-hover stagger-children text-center">
                <div class="img-zoom mx-auto h-48 w-48 overflow-hidden rounded-md bg-primary-100 shadow-lg">
                    <img src="{{ asset('images/Nyasha.png') }}" alt="Nyasha E Whende" class="img-reveal h-full w-full object-cover">
                </div>
            ...
            <div class="reveal card-hover stagger-children text-center">
                <div class="img-zoom mx-auto h-48 w-48 overflow-hidden rounded-md bg-primary-100 shadow-lg">
                    <img src="{{ asset('images/rachel.png') }}" alt="Rachel N. Hakutangwi" class="img-reveal h-full w-full object-cover">
                </div>
            ...
            <div class="reveal card-hover stagger-children text-center">
                <div class="img-zoom mx-auto h-48 w-48 overflow-hidden rounded-md bg-primary-100 shadow-lg">
                    <img src="{{ asset('images/team/Tinashe.jpeg') }}" alt="Tinashe Y Chadenga" class="img-reveal h-full w-full object-cover">
                </div>
            ...
            <div class="reveal card-hover stagger-children text-center">
                <div class="img-zoom mx-auto h-48 w-48 overflow-hidden rounded-md bg-primary-100 shadow-lg">
                    <img src="{{ asset('images/team/Doreen.jpeg') }}" alt="Doreen Mabhiza" class="img-reveal h-full w-full object-cover">
                </div>
