    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid items-center gap-12 lg:grid-cols-2">
            <div class="reveal">
                ...
                <h1 class="mt-6 font-heading text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">{{ $product['name'] }}</h1>
                <p class="mt-6 text-lg leading-relaxed text-neutral-300">{{ $product['subtitle'] }}</p>
                <div class="mt-8 flex flex-wrap gap-4">
                    <a href="{{ route('contact') }}" class="btn-primary text-sm">Get a Quote</a>
                    <a href="{{ route('services') }}" class="btn-secondary border-white text-white hover:bg-white hover:text-neutral-900 text-sm">All Products</a>
                </div>
            </div>
            <div class="reveal-scale relative">
                <div class="img-zoom aspect-[4/3] overflow-hidden rounded-md shadow-2xl">
                    <img src="{{ asset('images/' . Str::slug($product['name']) . '.png') }}" alt="{{ $product['name'] }}" class="img-reveal h-full w-full object-cover" onerror="this.src='{{ asset('images/abstractpattern.png') }}'">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="stagger-children mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="card-hover group">
                ...
                <p class="mt-2 text-sm leading-relaxed text-neutral-600">Tailored reinsurance capacity and expert underwriting support for {{ lcfirst($feature) }} risks across the Zimbabwean market.</p>
            </div>
            @empty
            ...
            <aside class="lg:col-span-1">
                <div class="reveal sticky top-24 rounded-md bg-white p-6 shadow-sm ring-1 ring-neutral-100">
                    ...
                    <ul class="mt-6 space-y-3">
                        <li>
                            <a href="{{ route('services') }}" class="card-hover flex items-center gap-3 rounded-md px-4 py-3 text-sm font-medium text-neutral-700 transition-colors hover:text-primary-600">
...
<section class="relative overflow-hidden bg-gradient-to-br from-primary-700 via-primary-600 to-primary-800 py-20 lg:py-28">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-3xl text-center">
            ...
            <p class="reveal mt-6 text-lg leading-relaxed text-primary-100">Let our team of experienced reinsurance brokers help you structure the optimal programme for {{ $product['name'] }}. Contact us today for a confidential discussion.</p>
            <div class="reveal mt-10 flex flex-wrap items-center justify-center gap-4">
                <a href="{{ route('contact') }}" class="btn-primary bg-white text-primary-700 hover:bg-primary-50 hover:text-primary-800 shadow-lg shadow-primary-900/30">Request a Consultation</a>
