        ...
        <div class="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div class="reveal-scale relative">
                <div class="aspect-[4/3] overflow-hidden rounded-2xl shadow-2xl">
                    <img src="{{ asset('images/products/' . Str::slug($product['name']) . '.jpg') }}" alt="{{ $product['name'] }}" class="h-full w-full object-cover" onerror="this.src='{{ asset('images/hero-pattern.png') }}'">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="stagger-children mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="card-hover group">
                ...
                <p class="mt-2 text-sm leading-relaxed text-neutral-600">Tailored reinsurance capacity and expert underwriting support for {{ lcfirst($feature) }} risks across the African market.</p>
            </div>
            @empty
            ...
            <aside class="lg:col-span-1">
                <div class="reveal sticky top-24 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-neutral-100">
                    ...
                    <ul class="mt-6 space-y-3">
                        <li>
                            <a href="{{ route('services') }}" class="card-hover flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-neutral-700 transition-colors hover:text-primary-600">
